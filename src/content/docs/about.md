...
Cultural practices are hard to cite definitively. Where a convention is contested (for example, which way to fold the banana leaf), we say so and link to references rather than stating it as fact.
:::

Ready to help? See [how to contribute](/contribute/).
