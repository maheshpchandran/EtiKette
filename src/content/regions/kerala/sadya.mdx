---
title: The Sadya
summary: How a Kerala feast is laid out on a banana leaf and eaten course by course — and how to signal you're done.
order: 1
icon: "🍛"
tags: [sadya, feast, banana-leaf, onam]
sources:
...
:::hygiene
Servers move down the row ladling curries onto each leaf. Ask that the **serving ladle not touch your leaf** (a small lift-and-pour does it), so it can't carry food — or saliva spl­ash — from one diner's leaf to the next. At home, give each diner their own small katori for chutneys and pickles instead of a shared dish everyone reaches into.
:::

See **[Eating by Hand](/regions/kerala/hand-eating/)** for the technique, and **[Serving & Hosting](/regions/kerala/serving-and-hosting/)** for how to decline a refill politely.
